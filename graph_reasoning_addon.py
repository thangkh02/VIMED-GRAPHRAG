"""
Graph Reasoning Add-on for AMG Improved Notebook
Thêm vào Cell 16 của notebook để có tính năng suy luận graph
"""
...
def find_shortest_path(G, source: str, target: str, max_length: int = 5):
    """
    ...
    Returns:
        Shortest path with relations or None
    """
    try:
...
if __name__ == "__main__":
    ...
    print("3. find_shortest_path(G, source, target, max_length)")
    print("4. reason_about_entity(G, entity_name, context_depth)")
    print("5. find_related_entities(G, entity_name, top_k, min_confidence)")
